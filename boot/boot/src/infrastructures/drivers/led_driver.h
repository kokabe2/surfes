...
#ifndef BOOT_BOOT_SRC_INFRASTRUCTURES_DRIVERS_LED_DRIVER_H_
#define BOOT_BOOT_SRC_INFRASTRUCTURES_DRIVERS_LED_DRIVER_H_
...
#endif  // BOOT_BOOT_SRC_INFRASTRUCTURES_DRIVERS_LED_DRIVER_H_
