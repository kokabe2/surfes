...
#ifndef BOOT_BOOT_SRC_INFRASTRUCTURES_DRIVERS_IO_DATA_H_
#define BOOT_BOOT_SRC_INFRASTRUCTURES_DRIVERS_IO_DATA_H_
...
#endif  // BOOT_BOOT_SRC_INFRASTRUCTURES_DRIVERS_IO_DATA_H_
